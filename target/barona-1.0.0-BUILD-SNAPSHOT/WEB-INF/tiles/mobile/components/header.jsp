...
<div id="header">
	...
	<div class="gnb_sub swiper-container" id="sub03">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide"><a href="#">통증클리닉</a></div>
		</div>
	</div>
	<div class="gnb_sub swiper-container" id="sub04">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide"><a href="${pageContext.request.contextPath }/m/treatment/treatment_5.do">척추 신경성형술</a></div>
			<div class="swiper-slide"><a href="${pageContext.request.contextPath }/m/treatment/treatment_6.do">척추 신경풍선 확장술</a></div>
			<div class="swiper-slide"><a href="${pageContext.request.contextPath }/m/treatment/treatment_7.do">디스크 고주파 열 치료술</a></div>
		</div>
	</div>
	<div class="gnb_sub swiper-container" id="sub05">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide"><a href="${pageContext.request.contextPath }/m/counsel/reserve.do">간편예약</a></div>
		</div>
	</div>
			...
			<ul class="menu_left">
				...
				<li class="menu4"><a href="#">치료법</a>
					<ul class="sub_menu">
						...
						<li><a href="${pageContext.request.contextPath }/m/treatment/treatment_5.do">척추 신경성형술</a></li>
						<li><a href="${pageContext.request.contextPath }/m/treatment/treatment_6.do">척추 신경풍선 확장술</a></li>
						<li><a href="${pageContext.request.contextPath }/m/treatment/treatment_7.do">디스크 고주파 열 치료술</a></li>
					</ul>
				</li>
				<li class="menu5"><a href="#">상담 &amp; 예약</a>
					<ul class="sub_menu">
						...
						<li><a href="${pageContext.request.contextPath }/m/counsel/reserve.do">간편예약</a></li>
					</ul>
				</li>
			</ul>
		</div>
