...
<link href="${pageContext.request.contextPath }/resources/mobile/css/main.css?ver=${ver}" rel="stylesheet"> 
<link href="${pageContext.request.contextPath }/resources/mobile/css/menu.css?ver=${ver}" rel="stylesheet"> 
<link href="${pageContext.request.contextPath }/resources/mobile/css/sub.css?ver=${ver}" rel="stylesheet"> 
<link href="${pageContext.request.contextPath }/resources/mobile/css/footer.css?ver=${ver}" rel="stylesheet"> 
...
<body>
	<div id="wrapper">
		<tiles:insertAttribute name="mHeader" />
		<tiles:insertAttribute name="mContent" />
		<tiles:insertAttribute name="mFooter" />
	</div>
</body>
</html>