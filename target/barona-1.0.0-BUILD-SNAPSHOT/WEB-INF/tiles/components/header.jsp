	...
	<div class="top">
		...
		<div class="util">
			<ul>
				...
				<li><a href="${pageContext.request.contextPath}/admin/notice/list.do?menu_code=01">관리자</a></li>
	...
	<div class="gnb_wrap">
		<div id="gnb">
			<ul id="gnb_list">
				...
				<li class="menu04">
					...
					<div class="sub_list" style="overflow: hidden; display: none; height: 200px; padding-top: 40px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">
						...
						<div class="inner">
	                        ...
	                        <ul>
	                     	    <li><a href="${pageContext.request.contextPath }/treatment/treatment_5.do">척추 신경성형술</a></li>
	                            <li><a href="${pageContext.request.contextPath }/treatment/treatment_6.do">척추 신경풍선 확장술</a></li>
	                            <li><a href="${pageContext.request.contextPath }/treatment/treatment_7.do">디스크 고주파 열 치료술</a></li>
							</ul>
						</div>
	                       <div class="gnb-brn">
				...
				<li class="menu05">
					<a href="${pageContext.request.contextPath }/counsel/notice_list.do"><span><i class="fas fa-clipboard-list"></i>상담</span></a>
					<div class="sub_list" style="overflow: hidden; display: none; height: 200px; padding-top: 40px; margin-top: 0px; padding-bottom: 0px; margin-bottom: 0px;">
						<div class="txt-title">
							<strong>상담</strong>
						...
						<div class="inner">
							<ul>
								...
								<li><a href="${pageContext.request.contextPath }/counsel/reserve.do">간편예약</a></li>
							</ul>
							<ul>
