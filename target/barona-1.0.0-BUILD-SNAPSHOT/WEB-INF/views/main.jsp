...
<script>
	...
	function openPopup() {
		...
		/*
		if(cookieCheck != 'N')
			 window.open("${pageContext.request.contextPath }/popUp/pop_up.do", "a", "width=395, height=543, left=0, top=90, scrollbars=no, resizable=no, toolbars=no, menubar=no"); */
	}
...
<div id="container">
    ...
    <div class="section01">
		<div>
			...
			<div class="pain">
				<ul>
					<li>
						<a href="${pageContext.request.contextPath}/disease/disease_2-1.do">
					...
					<li>
						<a href="${pageContext.request.contextPath}/disease/disease_8-1.do">
					...
					<li>
						<a href="${pageContext.request.contextPath}/disease/disease_7-1.do">
	...
	<div class="section03">
		<div class="con_wrap02 clearfix" style="border: 1px solid #dedede; font-size: 0;">
			...
			<div class="float">
				<a href="${pageContext.request.contextPath}/intro/intro_3.do"><img alt="오시는길" src="${pageContext.request.contextPath}/resources/images/main/main_map.png"></a>
			</div>
		</div>
	</div>
</div>
