...
<div id="container">
	<div class="sub pad">
		<h1><img src="${pageContext.request.contextPath }/resources/images/commons/tit_sub.jpg" style="width: 42%;"/></h1>
		<h2 style="margin: 15px 0 30px;"><img src="${pageContext.request.contextPath }/resources/images/intro/tit_intro_4.jpg" style="width: 22%;"/></h2>
		<div class="info01">
		...
		<div class="btn-box">
			<a href="${pageContext.request.contextPath }/counsel/reserve.do" class="btn-m">간편예약</a>
		</div>
	</div>
	<script>
	    var current = 1;
