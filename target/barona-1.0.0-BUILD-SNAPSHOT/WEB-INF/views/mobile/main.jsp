...
<div id="container">
	<div class="pain">
		...
		<ul>
			<li>
				<a href="${pageContext.request.contextPath}/m/disease/disease_2.do">
			...
			<li>
				<a href="${pageContext.request.contextPath}/m/disease/disease_8.do">
			...
			<li>
				<a href="${pageContext.request.contextPath}/m/disease/disease_7.do">
	...
	<div class="banner">
		...
		<div style="margin: 20px 0 0; border: 1px solid #dedede; border-bottom: none;">
			<div class="sec03">
				<a href="#"><img src="${pageContext.request.contextPath }/resources/images/main/main_park.jpg" /></a>
			</div>
			<div class="sec04">
