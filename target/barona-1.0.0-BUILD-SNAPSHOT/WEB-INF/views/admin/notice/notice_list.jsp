...
<div id="container">
	<div class="content">
					...
					<c:otherwise>
						<c:forEach var="notice" items="${noticeList}">
							<tr>
								...
								<td class="left"><a href="view.do${pageMaker.makeSearch(cri.page)}&no=${notice.noticeNo }">${notice.noticeTitle }</a></td>
								<td>바로나<br/>관리자</td>
		...
		<div style="text-align : right; margin: 15px 0 0;">
			<button class="btn_list" id="register" onclick="javascript:location.href='register.do'">등록</button>
		</div>
			...
			<div class="paging">
			  <ul>
				...
				<c:when test="${pageMaker.pprev }">
			      <a href="list.do${pageMaker.makeSearch(1)}">
			    ...
			    <c:choose>
			   	<c:when test="${pageMaker.prev }">
			   	  <a href="list.do${pageMaker.makeSearch(pageMaker.startPage - 1) }">
			    ...
			    <c:when test="${pageMaker.nnext}">
			      ...
			      <a href="list.do?page=${page_nnext }&perPageNum=${pageMaker.cri.perPageNum }&searchType=${pageMaker.cri.searchType }&keyword=${pageMaker.cri.keyword }">
